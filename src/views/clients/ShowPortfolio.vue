      ...
      <b-tbody>
        <b-tr v-for="(item, index) in this.info" v-bind:key="index">
          ...
          <a :href="'/stock/' + index" target="_blank">
            <b-td
              v-if="
                infoFinances[index].quoteResponse.result[0].hasOwnProperty(
                  'longName'
                )
              "
              >{{ infoFinances[index].quoteResponse.result[0].longName }}</b-td
            >
            <b-td v-else>{{
          ...
          <b-td
            ...
            v-if="
              item.quantity *
                infoFinances[index].quoteResponse.result[0]
                  .regularMarketChange *
                0.87 >
              0
            "
          ...
          >
          <b-td class="gypred" v-else>{{
            (
              item.quantity *
              infoFinances[index].quoteResponse.result[0].regularMarketChange *
              0.87
            ).toFixed(2) + " €"
          }}</b-td>
          <!--% hoy-->
          <b-td
            ...
            >{{
              infoFinances[
                index
              ].quoteResponse.result[0].regularMarketChangePercent.toFixed(2)
            }}%</b-td
          >
          <b-td
            v-else-if="
          ...
          <b-td
            v-if="
              infoFinances[index].quoteResponse.result[0].currency === 'USD'
            "
            >{{
              infoFinances[
                index
              ].quoteResponse.result[0].regularMarketPrice.toFixed(2) + " $"
            }}</b-td
          >
          <b-td
            v-else-if="
              infoFinances[index].quoteResponse.result[0].currency === 'EUR'
            "
            >{{
              infoFinances[
                index
          ...
          <b-td
            ...
            >{{
              (
                infoFinances[index].quoteResponse.result[0].regularMarketPrice *
                item.quantity
              ).toFixed(2) + " $"
            }}</b-td
          >
          ...
          >
          <!--GyP total-->
          <b-td class="gypgreen" v-if="gyp[index] > 0">{{
            gyp[index].toFixed(2) + " €"
          }}</b-td>
          <b-td v-else-if="gyp[index] == 0">{{
            gyp[index].toFixed(2) + " €"
          }}</b-td>
  ...
  methods: {
    ...
    cuentas() {
      ...
      for (let item in this.info) {
        ...
        aux =
          this.infoFinances[item].quoteResponse.result[0].regularMarketPrice -
          this.info[item].buyPrice;
        //gp = aux * cantidad
