...
export default {
  ...
  methods: {
    getPieChart() {
      ...
      if(infoFinances[index].quoteResponse.result[0].currency === 'USD')
      let marketValueStockDetail = JSON.parse(localStorage.getItem("infoFinances"))[this.id].quoteResponse.result[0].regularMarketPrice * stockInfo.quantity
      console.log(stockInfo)
      console.log(marketValueStockDetail)
      /*let sectors = new Map()
