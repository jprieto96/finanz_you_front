...
export default {
  ...
  methods: {
    getPieChart() {
      ...
      this.pieChartData.push({'x': this.id, 'y': percentageOfParticularStock, text: this.id + " hola"})
      this.pieChartData.push({'x': "Resto de la cartera", 'y': restPercentage, text: "Resto de la cartera" + " hola"})
