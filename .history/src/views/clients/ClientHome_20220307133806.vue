    ...
    <div class="control-section" v-if="showPieChart">
      <div align='center'>
        <ejs-accumulationchart style='display:inline-block' :load='loadStocks' align='center' id='chartcontainer2' :title="'% activos de tu cartera'"
                               :legendSettings='legendSettingsStocks' :tooltip='tooltipStocks'>
          <e-accumulation-series-collection>
            <e-accumulation-series :dataSource='pieChartDataStocks' xName='x' yName='y' startAngle='60' :dataLabel='dataLabelStocks' innerRadius='0%' name='Sectores' > </e-accumulation-series>
